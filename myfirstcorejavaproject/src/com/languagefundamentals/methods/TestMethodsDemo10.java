...
//			Area of Triangle : 0.5 * breadth * height
			...
			double AreaOfTriangle = findAreaOfTriangle(base, height);
...
//			Area of Rectangle: length * breadth
			...
			int AreaOfRectangle = (int) findAreaOfRectangle(length, breadth);
...
//			Area of Square : side * side
			...
			double AreaOfSquare = findAreaOfSquare(side);
...
//			Area of Circle : PI * r * r
		...
		static double findAreaOfTriangle(double b, float h) {
			double AreaOfTriangle = 0.5 * b * h;
			return AreaOfTriangle;
		}
		
		static double findAreaOfRectangle(byte l,int b) {
